---
name: apple-contacts
description: Look up contacts from macOS Contacts.app via AppleScript.
metadata:
  hermes:
    version: "1.0"
    ported_from: sundial-org/awesome-openclaw-skills/skills/apple-contacts
    tested_with: hermes 0.5+
    tools: ['terminal']
    source_url: https://clawskills.sh/skills/apple-contacts
---
# Apple Contacts
