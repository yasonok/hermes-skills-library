---
name: voice-wake-say
description: Speak responses aloud on macOS using built-in `say`.
metadata:
  hermes:
    version: "1.0"
    ported_from: sundial-org/awesome-openclaw-skills/skills/voice-wake-say
    tested_with: hermes 0.5+
    tools: ['terminal', 'tts']
    source_url: https://clawskills.sh/skills/voice-wake-say
---
# Voice Wake Say
